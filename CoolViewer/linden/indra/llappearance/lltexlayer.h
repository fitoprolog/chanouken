...
public:
	...
	void					requestUpdate();
	virtual void gatherAlphaMasks(U8* data, S32 origin_x, S32 origin_y,
...
public:
	...
	void gatherAlphaMasks(U8* data, S32 origin_x, S32 origin_y, S32 width,
						  S32 height) override;
...
public:
	...
	LLTexLayer(const LLTexLayerTemplate& layer_template,
			   LLLocalTextureObject* lto, LLWearable* wearable);
	...
	void addAlphaMask(U8* data, S32 origin_x, S32 origin_y, S32 width,
					  S32 height);
	bool isInvisibleAlphaMask() const override;

	LL_INLINE void setLTO(LLLocalTextureObject* lto) 	{ mLocalTextureObject = lto; }
...
public:
	...
	void gatherMorphMaskAlpha(U8* data, S32 origin_x, S32 origin_y, S32 width,
							  S32 height);
	...
	void cloneTemplates(LLLocalTextureObject* lto,
