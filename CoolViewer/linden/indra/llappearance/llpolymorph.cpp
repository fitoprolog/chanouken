	...
	mSuccessfullyAllocated(false)
{
	...
	S32 vert_size = sizeof(LLVector4a) * numVertices;
	...
	S32 tex_size = (numVertices * sizeof(LLVector2) + 0xF) & ~0xF;
	...
	mVertexIndices = (U32*)allocate_volume_mem(numVertices * sizeof(U32));
	if (!mVertexIndices)
	{
		freeData();
		return;
