...
public:
	...
	// hierarchy
	LL_INLINE virtual void updateBranchParent(LLView*)
	{
	}
...
public:
	...
	{
		mCallback = callback; mUserData = data;
	}
...
// TODO: The menu and menu item classes share a great deal of functionality and
// perhaps should be united. I think it may make the most sense to make
// LLMenuGL be a subclass of LLMenuItemGL. -MG
class LLMenuGL : public LLUICtrl
{
	// Ket branching menu items use my protected traversal methods
