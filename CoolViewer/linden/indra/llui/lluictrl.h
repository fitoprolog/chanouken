...
public:
	...
	// Return NULL by default (overrride if the class has the appropriate
	// interface)
	virtual class LLCtrlSelectionInterface* getSelectionInterface()	{ return NULL; }
	virtual class LLCtrlListInterface* getListInterface()			{ return NULL; }
	virtual class LLCtrlScrollInterface* getScrollInterface()		{ return NULL; }
