...
class LLComboBox : public LLUICtrl, public LLCtrlListInterface
{
public:
	...
	LL_INLINE LLCtrlListInterface* getListInterface() override
	{
		return (LLCtrlListInterface*)this;
	}
	...
	void setColumnLabel(const std::string& col, const std::string& l) override;
	...
	// LLCtrlSelectionInterface methods

	LL_INLINE bool getCanSelect() const override		{ return true; }
	LL_INLINE bool selectFirstItem() override			{ return setCurrentByIndex(0); }
	LL_INLINE bool selectNthItem(S32 index) override	{ return setCurrentByIndex(index); }
	bool selectItemRange(S32 first, S32 last) override;

	LL_INLINE S32 getFirstSelectedIndex() const override
	{
		return getCurrentIndex();
	}

	bool setCurrentByID(const LLUUID& id) override;
	LLUUID getCurrentID() const override;
	...
	// End of LLCtrlSelectionInterface methods
