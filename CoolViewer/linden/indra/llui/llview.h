...
// A view is an area in a window that can draw.  It might represent the HUD or
// a dialog box or a button.  It can also contain sub-views and child widgets
...
public:
	...
	LL_INLINE virtual bool isPanel() const				{ return false; }
...
#if 0	// Not used
	LL_INLINE bool hasChild(const char* childname, bool recurse = false) const
	{
	...
	virtual void setControlName(const char* control, LLView* context);
	...
	template<class T> T& getChildRef(const char* name,
