...
public:
	...
	LL_INLINE S32 getItemCount() const override				{ return mItemList.size(); }
	...
	LL_INLINE LLCtrlScrollInterface* getScrollInterface() override
	{
		return (LLCtrlScrollInterface*)this;
	}

	// DEPRECATED: Use selectByID() below.
	LL_INLINE bool setCurrentByID(const LLUUID& id) override
	{
		return selectByValue(LLSD(id));
	}

	LL_INLINE virtual LLUUID getCurrentID() const override
	{
	...
	LL_INLINE bool getCanSelect() const override			{ return mCanSelect; }
