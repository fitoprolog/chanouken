...
public:
	...
	virtual bool init(S32 num_channels, void* userdata);
	...
	LL_INLINE bool isUISound(const LLUUID& uuid)		{ return mUISounds.count(uuid) != 0; }
	...
	static bool getUISoundFile(const LLUUID& uuid, std::string& sound_file,
	...
	static void assetCallback(const LLUUID& uuid, LLAssetType::EType, void*,
...
public:
	...
	LL_INLINE bool hasValidData() const					{ return mHasValidData; }

	LL_INLINE void setHasLocalData(bool hld)			{ mHasLocalData = hld; }
	LL_INLINE void setHasDecodedData(bool hdd)			{ mHasDecodedData = hdd; }
	LL_INLINE void setHasValidData(bool hvd)			{ mHasValidData = hvd; }
...
protected:
	...
	LLUUID			mOwnerID;		// Owner of the sound source
