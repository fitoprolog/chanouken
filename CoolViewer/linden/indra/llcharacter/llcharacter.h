...
public:
	...
	virtual void getGround(const LLVector3& inPos, LLVector3& outPos,
						   LLVector3& outNorm) = 0;
	...
	LL_INLINE void	setSkeletonSerialNum(U32 num)				{ mSkeletonSerialNum = num; }
...
private:
	...
	// NOTE: do not replace with flat_hmap: this would not work porperly... HB
