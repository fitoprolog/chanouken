...
public:
	...
	LL_INLINE const LLVector3& getPosition()			{ return mXform.getPosition(); }
	...
	const LLVector3& getLastWorldPosition();
	...
	LL_INLINE const LLVector3& getSkinOffset()			{ return mSkinOffset; }
