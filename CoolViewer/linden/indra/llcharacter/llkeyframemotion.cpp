...
bool LLKeyframeMotion::onUpdate(F32 time, U8* joint_mask)
{
	...
	if (time - mLastUpdateTime < 0.f)
	{
		...
		llwarns_once << "Negative time passed; time delta zeroed." << llendl;
	}
...
// such animations.
bool LLKeyframeMotion::deserialize(LLDataPacker& dp, bool allow_invalid_joints)
{
	// Check version
	U16 version;
