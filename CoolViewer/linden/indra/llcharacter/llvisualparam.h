...
public:
	...
	LL_INLINE bool isTweakable() const						{ return getGroup() == VISUAL_PARAM_GROUP_TWEAKABLE ||
																		 getGroup() == VISUAL_PARAM_GROUP_TWEAKABLE_NO_TRANSMIT; }
