...
public:
	...
	// DO NOT INITIALIZE: Tte overhead is completely unnecessary
	...
	{
		alignas(16) static const U32 F_ABS_MASK_4A[4] = {
	...
	{
		mQ = _mm_xor_ps(*reinterpret_cast<const LLQuad*>(sSignMask), mQ);
	}
...
private:
	...
	alignas(16) static const U32	sSignMask[4];
};
