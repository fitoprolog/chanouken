	...
	mZAxis(0.f, 0.f, 1.f)
{
	...
	{
		reset();
		llwarns_once << "Non finite (1). Coordinates reset." << llendl;
	}
}
...
:	mOrigin(origin)
{
	...
	{
		reset();
		llwarns_once << "Non finite (2). Coordinates reset." << llendl;
	}
}
	...
	mZAxis(z_axis)
{
	...
	{
		reset();
		llwarns_once << "Non finite (3). Coordinates reset." << llendl;
	}
}
	...
	mZAxis(z_axis)
{
	...
	{
		reset();
		llwarns_once << "Non finite (4). Coordinates reset." << llendl;
	}
}
	...
	mZAxis(rotation.mMatrix[VZ])
{
	...
	{
		reset();
		llwarns_once << "Non finite (5). Coordinates reset." << llendl;
	}
}
...
LLCoordFrame::LLCoordFrame(const LLQuaternion& q) noexcept
{
	...
	{
		reset();
		llwarns_once << "Non finite (6). Coordinates reset." << llendl;
	}
}
...
:	mOrigin(origin)
{
	...
	{
		reset();
		llwarns_once << "Non finite. Coordinates reset." << llendl;
	}
}
	...
	mZAxis(mat.mMatrix[VZ])
{
	...
	{
		reset();
		llwarns_once << "Non finite (7). Coordinates reset." << llendl;
	}
}
	...
	mZAxis(rotation + 3 * VZ)
{
	...
	{
		reset();
		llwarns_once << "Non finite (8). Coordinates reset." << llendl;
	}
}
	...
	mZAxis(origin_and_rotation + 3 * (VZ + 1))
{
	...
	{
		reset();
		llwarns_once << "Non finite (9). Coordinates reset." << llendl;
	}
}
