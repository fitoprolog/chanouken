...
public:
	...
	LL_INLINE F32 brightness() const		{ return (mV[0] + mV[1] + mV[2]) / 3.0f; }
...
LL_INLINE const LLColor3 linearColor3(const LLColor3& a)
{
	return LLColor3(sRGBtoLinear(a.mV[0]), sRGBtoLinear(a.mV[1]),
					sRGBtoLinear(a.mV[2]));
}
