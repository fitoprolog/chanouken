...
public:
	...
	// Return vector a minus b
	friend LLColor4 operator-(const LLColor4& a, const LLColor4& b);
	// Return component wise a * b
	friend LLColor4 operator*(const LLColor4& a, const LLColor4& b);
	// Return rgb times scaler k (no alpha change)
	friend LLColor4 operator*(const LLColor4& a, F32 k);
	// Return rgb divided by scalar k (no alpha change)
	friend LLColor4 operator/(const LLColor4& a, F32 k);
	// Return rgb times scaler k (no alpha change)
	friend LLColor4 operator*(F32 k, const LLColor4& a);
	// Return alpha times scaler k (no rgb change)
	friend LLColor4 operator%(const LLColor4& a, F32 k);
	// Return alpha times scaler k (no rgb change)
	friend LLColor4 operator%(F32 k, const LLColor4& a);
