...
#  set(BOOST_THREAD_LIBRARY boost_thread-mt)
	...
	elseif (LINUX)
		if (${CXX_VERSION} GREATER 549 AND NOT (${CXX_VERSION} GREATER 559))
			use_prebuilt_binary(boost-static-gcc55)
		else ()
			...
			# gcc version than the version used to build boost itself (v5.5.0),
			# so let's use their shared libraries counterparts in that case (at
			# the cost of a larger distribution package)...
			use_prebuilt_binary(boost)
		endif ()

		# For now, the ARM64 version of boost is v1.76 that got a header-only
		# boost::atomic implementation, unlike v1.77+ used for x86_64...
		if (ARCH STREQUAL "x86_64")
