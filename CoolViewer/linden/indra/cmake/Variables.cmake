...
if (${CMAKE_SYSTEM_NAME} MATCHES "Darwin")
	...
	# This does not work for Xcode 12 (which needs the macosx11.1 SDK) and
	# should get automatically and porperly set by cmake anyway.
...
if (${CMAKE_SYSTEM_NAME} MATCHES "Windows")
	...
	if (${CMAKE_CXX_COMPILER_ID} MATCHES "Clang")
		set(USING_CLANG ON)
	elseif (NOT MSVC14)
		message(FATAL_ERROR "You need VS2017 (or VS2019 with the VC v141 toolset) to build this viewer !")
	endif ()
