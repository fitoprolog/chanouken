...
void gl_rect_2d(S32 left, S32 top, S32 right, S32 bottom, bool filled)
{
	...
	else if (gGLManager.mATIOffsetVerticalLines)
	{
...
void gl_draw_image(S32 x, S32 y, LLGLTexture* image, const LLColor4& color,
				   const LLRectf& uv_rect)
{
	...
	gl_draw_scaled_rotated_image(x, y, image->getWidth(0), image->getHeight(0),
								 0.f, image, color, uv_rect);
}

void gl_draw_scaled_image(S32 x, S32 y, S32 width, S32 height,
						  LLGLTexture* image, const LLColor4& color,
						  const LLRectf& uv_rect)
{
	if (!image)
	{
									  ...
									  const LLRectf& uv_rect)
{
	...
	gl_draw_scaled_image_with_border(x, y, width, height, image, color,
...
void gl_draw_rotated_image(S32 x, S32 y, F32 degrees, LLGLTexture* image,
						   const LLColor4& color, const LLRectf& uv_rect)
{
	gl_draw_scaled_rotated_image(x, y, image->getWidth(0), image->getHeight(0),
								 degrees, image, color, uv_rect);
}

void gl_draw_scaled_rotated_image(S32 x, S32 y, S32 width, S32 height,
								  F32 degrees, LLGLTexture* image,
