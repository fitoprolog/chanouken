/**
 * @file llphysicsshapebuilderutil.h
...
public:
	...
	public:
		...
		LL_INLINE PhysicsShapeSpecification()
		:	mType(INVALID),
			mScale(0.f, 0.f, 0.f),
			mCenter(0.f, 0.f, 0.f)
		{
		...
		LL_INLINE bool isConvex()				{ return mType != USER_MESH && mType != PRIM_MESH && mType != INVALID; }
		LL_INLINE bool isMesh()					{ return mType == USER_MESH || mType == PRIM_MESH; }
	...
	static void determinePhysicsShape(const LLPhysicsVolumeParams& volume_params,
