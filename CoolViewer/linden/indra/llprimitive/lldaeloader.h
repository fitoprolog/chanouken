...
public:
	...
	LLDAELoader(std::string filename, S32 lod,
...
protected:
	...
	static bool addVolumeFacesFromDomMesh(LLModel* modelp, domMesh* meshp,
										  LLSD& log_msg);
	static bool createVolumeFacesFromDomMesh(LLModel* modelp, domMesh* meshp);

	static LLModel* loadModelFromDomMesh(domMesh* meshp);
