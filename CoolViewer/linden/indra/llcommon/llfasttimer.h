...
public:
	enum EFastTimerType
	{
		...
		FTM_FACE_GET_GEOM,
		FTM_FACE_GEOM_INDEX,
		FTM_FACE_GEOM_INDEX_TAIL,
		FTM_FACE_GEOM_POSITION,
		FTM_FACE_POSITION_STORE,
		FTM_FACE_POSITION_PAD,
		FTM_FACE_GEOM_COLOR,
		...
		FTM_FACE_TEX_QUICK,
		FTM_FACE_TEX_QUICK_NO_XFORM,
		FTM_FACE_TEX_QUICK_XFORM,
		FTM_FACE_TEX_DEFAULT,
		FTM_FACE_TEX_QUICK_PLANAR,
