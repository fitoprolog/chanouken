...
void ll_init_apr()
{
	...
	// APR must be done at the program late exit step).
...
bool ll_apr_warn_status(apr_status_t status)
{
	...
	// some reads (reads till EOF), especially seen in object cache code...
	if (status == APR_EOF) return true;
#endif
	char buf[MAX_STRING];
