...
protected:
	...
	{
		return mUseCount > 1 && mUseCount != STATIC_USAGE_COUNT;
	}
...
public:
	...
	// assignments, othewise the default implementation handless constructing
	...
	LL_INLINE virtual int size() const						{ return 0; }
	LL_INLINE virtual LLSD get(Integer) const				{ return LLSD(); }
	LL_INLINE virtual void erase(Integer)					{}
	LL_INLINE virtual const LLSD& ref(Integer) const		{ return undef(); }
...
#endif
{
	...
	public:
		...
		LL_INLINE virtual void assign(LLSD::Impl*& var, DataRef value)
		{
			if (shared())
			{
	...
	public:
		...
		LL_INLINE int size() const override					{ return mValue.size(); }
	...
	public:
		...
		LL_INLINE int size() const override					{ return mData.size(); }
	...
	public:
		...
		LLSD get(LLSD::Integer i) const override;
		void set(LLSD::Integer i, const LLSD& v);

		void insert(LLSD::Integer i, const LLSD& v);
		...
		void erase(LLSD::Integer i) override;

		LLSD& ref(LLSD::Integer i);
		const LLSD& ref(LLSD::Integer i) const override;
...
#endif
{
	LL_INLINE LLSD::Impl& safe(LLSD::Impl* impl)
	{
		return LLSD::Impl::safe(impl);
	}

#if 0	// Not used
	LL_INLINE const LLSD::Impl& safe(const LLSD::Impl* impl)
	{
		return LLSD::Impl::safe(impl);
	}
#endif
...
void LLSD::set(Integer i, const LLSD& v)
{
