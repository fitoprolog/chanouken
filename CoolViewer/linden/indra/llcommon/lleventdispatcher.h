...
public:
	LLEventDispatcher(const std::string& desc, const std::string& key,
					  const std::string& reply_key = std::string("reply"));
	...
	// if event contains the reply key specified to our constructor, log a
	// warning and send a reply LLSD::Map containing key "error" whose value
	// is a string describing the problem. If reply key is not present, die
	// with llerrs.
	...
	// error. On error, if event contains the reply key specified to our
	// constructor, log a warning and send a reply LLSD::Map containing key
	// "error" whose value is a string describing the problem. If reply key is
	// not present, die with llerrs.
	...
	// specified at add() time, it is an error. On error, if event contains the
	// reply key specified to our constructor, log a warning and send a reply
	// LLSD::Map containing key "error" whose value is a string describing the
	// problem. If reply key is not present, die with llerrs.
	...
	// prototype specified at add() time, it is an error. On error, if event
	// contains the reply key specified to our constructor, log a warning and
	// send a reply LLSD::Map containing key "error" whose value is a string
	// describing the problem. If reply key is not present, die with llerrs.
...
private:
	...
	// Implements error behavior: if event contains the reply_key specified to
	// our constructor, log a warning and send a reply LLSD::Map containing key
	// "error" whose value is the passed @a message. If reply_key is not
	// present, die with llerrs.
