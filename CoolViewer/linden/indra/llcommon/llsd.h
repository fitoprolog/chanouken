...
class LL_COMMON_API LLSD final	// This class may NOT be subclassed
{
public:
	...
	// Convenience constructor for F32 to Real
	LLSD(F32);
	...
	LL_INLINE LLSD& operator=(Boolean v)		{ assign(v); return *this; }
	LL_INLINE LLSD& operator=(Integer v)		{ assign(v); return *this; }
	LL_INLINE LLSD& operator=(Real v)			{ assign(v); return *this; }
	LL_INLINE LLSD& operator=(const String& v)	{ assign(v); return *this; }
	LL_INLINE LLSD& operator=(const UUID& v)	{ assign(v); return *this; }
	LL_INLINE LLSD& operator=(const Date& v)	{ assign(v); return *this; }
	LL_INLINE LLSD& operator=(const URI& v)		{ assign(v); return *this; }
	LL_INLINE LLSD& operator=(const Binary& v)	{ assign(v); return *this; }
