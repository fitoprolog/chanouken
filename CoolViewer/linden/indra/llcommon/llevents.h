...
#include "boost/ref.hpp"						// For reference_wrapper
...
#if 0	// Enable this to allow binding free functions with more parameters
...
public:
	...
	// This is syntactically similar to
	// LLEventPumps::getInstance()->post(name, message)
...
// LLStandardSignal::slot_type) because the boost::get_pointer() utility
// function is not specialized for boost::weak_ptr. This remedies that
// omission.
namespace boost
{
	template <typename T>
