...
LL_COMMON_API LL_NO_INLINE void errorUsedInConstructor(const std::type_info& type);
LL_COMMON_API LL_NO_INLINE void warnAccessingDeletedSingleton(const std::type_info& type);
