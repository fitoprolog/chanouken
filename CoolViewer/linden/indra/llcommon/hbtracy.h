...
// Tracy client configuration for the communications with the server: this must
// match exactly the configuration used to compile the Tracy client library
// (since we use a pre-compiled library for the client side).
