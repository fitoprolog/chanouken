...
public:
	typedef boost::signals2::signal<bool(LLControlVariable* control,
										 const LLSD&),
									boost_boolean_combiner> validate_signal_t;
	typedef boost::signals2::signal<void(LLControlVariable* control,
...
public:
	...
	typedef LLInstanceTracker<LLControlGroup,
							  std::string>::instance_iter instance_iter;
