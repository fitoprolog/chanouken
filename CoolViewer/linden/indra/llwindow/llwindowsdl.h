...
# include <X11/Xlib.h>
# include <X11/Xatom.h>
// Get X11-specific headers for use in low-level stuff like copy-and-paste
// support
# if LL_SDL2
...
protected:
	...
	S32				mHaveInputFocus;	// 0 = no, 1 = yes, else unknown
	S32				mIsMinimized;		// 0 = no, 1 = yes, else unknown
#endif
