...
//virtual
void LLWindowCallbacks::handlePingWatchdog(LLWindow*, const char*)
{
}

//virtual
void LLWindowCallbacks::handlePauseWatchdog(LLWindow*)
{
}

//virtual
void LLWindowCallbacks::handleResumeWatchdog(LLWindow*)
{
}
