...
public:
	...
	// Not constexpr because then gcc v5.5 fails to see them at compile time
	// in boost::bind constructs... Plus, this allows to name more tracks more
	// easily, and possibly add new ones easily as weel in the future.
	enum
	{
		TRACK_WATER 		= 0,
	...
	typedef boost::shared_ptr<LLSettingsWater> settings_water_ptr_t;
	typedef boost::shared_ptr<LLSettingsSky> settings_sky_ptr_t;

	typedef boost::shared_ptr<LLSettingsDay> ptr_t;
	typedef boost::weak_ptr<LLSettingsDay> wptr_t;
