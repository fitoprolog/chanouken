...
bool LLCacheName::importFile(std::istream& istr)
{
	...
	llinfos << "Loaded " << count << " agent names" << llendl;
...
// isn't a boost::function is so that trackable behavior doesn't get lost. As a
// result, we have to bind the slot to a signal to call it, even when we call
