...
public:
	...
	LL_INLINE bool isHandlerPresent(const key_t& name) const
	{
	...
	// value from.
	bool dispatch(const key_t& name, const LLUUID& invoice,
	...
	// on success.
	static bool unpackMessage(LLMessageSystem* msg, key_t& method,
							  LLUUID& invoice, sparam_t& parameters);

	static bool unpackLargeMessage(LLMessageSystem* msg, key_t& method,
								   LLUUID& invoice, sparam_t& parameters);
