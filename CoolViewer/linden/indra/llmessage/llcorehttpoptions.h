...
// Convenient shortcut
#define DEFAULT_HTTP_OPTIONS boost::make_shared<LLCore::HttpOptions>()
...
//
// Sharing instances across requests. It's intended that these be shared across
// requests: caller can create one of these, set it up as needed and then
// reference it repeatedly in HTTP operations. But see the Threading note about
// references.
//
...
class HttpOptions final : private boost::noncopyable
{
public:
