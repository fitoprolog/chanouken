 ...
 *
 * This class is responsible for managing two interconnected tasks, connecting
 * to a SOCKS 5 proxy for use by LLPacketRing to send UDP packets and managing
...
private:
	...
	/*#########################################################################
	MEMBERS WRITTEN IN MAIN THREAD AND READ IN ANY THREAD. ONLY READ OR WRITE
	AFTER LOCKING mProxyMutex !
	#########################################################################*/
