...
public:
	LLTextureFetch(LLTextureCache* cachep, LLImageDecodeThread* threadp);
	...
	LL_INLINE void lockQueue()								{ mQueueMutex.lock(); }
	LL_INLINE void unlockQueue()							{ mQueueMutex.unlock(); }
