...
static struct ft_display_info ft_display_table[] =
{
	...
	{ LLFastTimer::FTM_AREASEARCH_UPDATE,				"  Area Seacrh Update" },
...
//	{ LLFastTimer::FTM_LOAD_AVATAR,						"       Load Avatar" },
	...
	{ LLFastTimer::FTM_SERVICE_CALLBACK,				"    Callback" },
	...
	{ LLFastTimer::FTM_TEXTURE_MEMORY_CHECK,			"    Memory Check" },
	...
	{ LLFastTimer::FTM_FAST_CACHE_IMAGE_FETCH,			"   Fast Cache Fetch" },
#endif
	...
	{ LLFastTimer::FTM_GEN_DRAW_INFO_ALLOCATE,			"       Allocate VB" },
	...
	{ LLFastTimer::FTM_FACE_GEOM_INDEX_TAIL,			"       Tail" },
	{ LLFastTimer::FTM_FACE_GEOM_POSITION,				"      Position" },
	{ LLFastTimer::FTM_FACE_POSITION_STORE,				"       Store" },
	{ LLFastTimer::FTM_FACE_POSITION_PAD,				"       Pad" },
	...
	{ LLFastTimer::FTM_FACE_TEX_QUICK,					"       Quick" },
	{ LLFastTimer::FTM_FACE_TEX_QUICK_NO_XFORM,			"        No Xform" },
	{ LLFastTimer::FTM_FACE_TEX_QUICK_XFORM,			"        Xform" },
	{ LLFastTimer::FTM_FACE_TEX_QUICK_PLANAR,			"       Quick Planar" },
	{ LLFastTimer::FTM_FACE_TEX_DEFAULT,				"       Default" },
	...
	{ LLFastTimer::FTM_RENDER_GLOW_PUSH,				"      Glow Push" },
	...
	{ LLFastTimer::FTM_SEED_VBO_POOLS,					"  Seed VBO Pools" },
	...
	{ LLFastTimer::FTM_GL_FINISH,						"  GL finish" },
...
void HBTracyProfiler::launch()
{
	...
	{
		llwarns << "Tracy server executable not found. Cannot launch it."
				<< llendl;
		return;
	}
	...
	{
		llwarns << "Failed to launch the Tracy server executable." << llendl;
	}
}
