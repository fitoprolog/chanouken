...
public:
	...
	LL_INLINE F32 getTotal()					{ return mThrottleTotal; }
...
public:
	...
	LL_INLINE F32 getMaxBandwidth() const		{ return mMaxBandwidth; }
	LL_INLINE F32 getCurrentBandwidth() const	{ return mCurrentBandwidth; }

	void updateDynamicThrottle();
	void resetDynamicThrottle();

	LLViewerThrottleGroup getThrottleGroup(F32 bandwidth_kbps);
