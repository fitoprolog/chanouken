...
class alignas(16) LLViewerCamera : public LLCamera
{
protected:
...
public:
	...
	LL_INLINE LLStat* getVelocityStat()					{ return &mVelocityStat; }
	LL_INLINE LLStat* getAngularVelocityStat()			{ return &mAngularVelocityStat; }
