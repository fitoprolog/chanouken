...
public:
	...
	U32 LL_INLINE getVertexDataMask() override				{ return VERTEX_DATA_MASK; }

	LLDrawPoolSky();

	LL_INLINE S32 getNumPostDeferredPasses() override		{ return getNumPasses(); }
	LL_INLINE void beginPostDeferredPass(S32 p) override	{ beginRenderPass(p); }
	...
	LL_INLINE void setSkyTex(LLSkyTex* const st)			{ mSkyTex = st; }
