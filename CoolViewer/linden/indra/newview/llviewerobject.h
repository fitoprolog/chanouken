...
public:
	...
	virtual void idleUpdate(const F64& time);
	...
	S32 setTETextureCore(U8 te, LLViewerTexture* image);
	S32 setTENormalMapCore(U8 te, LLViewerTexture* image);
	S32 setTESpecularMapCore(U8 te, LLViewerTexture* image);
	...
	virtual void setTEImage(U8 te, LLViewerTexture* imagep);
	...
	LLHUDIcon* setIcon(LLViewerTexture* icon_image, F32 scale = 0.03f);
	...
	// pointer when the extra parameter does not exist or is not in use.
...
protected:
	...
	void doUpdateInventory(LLPointer<LLViewerInventoryItem>& item, U8 key,
						   bool is_new);
...
public:
	...
	// GL "name" used by selection code
	U32									mGLName;
...
protected:
	...
	// Given the small number (7, as I am writing this) of extra parameters, it
