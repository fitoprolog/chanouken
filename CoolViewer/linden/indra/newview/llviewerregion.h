...
public:
...
#if 0	// not used
	LL_INLINE void setBlockFly(bool b)						{ setRegionFlag(REGION_FLAGS_BLOCK_FLY, b); }
#endif
	...
	static std::string getMaturityIconName(U8 sim_access);
...
private:
	...
	void updateVisibleEntries(F32 max_time); // updates visible entries
