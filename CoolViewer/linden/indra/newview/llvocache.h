...
public:
	...
	typedef fast_hmap<U32, LLPointer<LLVOCacheEntry> > vocache_entry_map_t;
...
protected:
	...
	vocache_entry_set_t			mChildrenList;
...
public:
	...
	static F32 sPauseOcclusionEndTime;
...
public:
	...
	void readFromCache(U64 handle, const LLUUID& id,
					   LLVOCacheEntry::vocache_entry_map_t& cache_entry_map);
	void writeToCache(U64 handle,
