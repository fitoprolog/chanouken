...
public:
	...
	// in boost::make_shared constructs...
	enum EETransition
	{
	...
	class DayInstance : public boost::enable_shared_from_this<DayInstance>
	{
	public:
...
private:
	...
	struct UpdateInfo
	{
		typedef boost::shared_ptr<UpdateInfo> ptr_t;
...
{
public:
	typedef boost::shared_ptr<LLTrackBlenderLoopingManual> ptr_t;
