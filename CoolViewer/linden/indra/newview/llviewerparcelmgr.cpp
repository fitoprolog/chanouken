												...
												LLHandle<LLParcelInfoObserver> obs_handle)
{
	...
	LLCoros::getInstance()->launch("LLViewerParcelMgr::regionParcelInfoCoro",
								   boost::bind(&LLViewerParcelMgr::regionParcelInfoCoro,
											   this, url, region_id,
											   region_pos, global_pos,
											   obs_handle));
	return true;
}
