...
public:
	...
	// mPrintBuffer string and a the contents of that string is returned by
	// this function (and otherwise an empty string).
	...
	void onAgentBaked();
	void onRadar(const LLUUID& id, const std::string& name, U32 range);
...
public:
	...
	void setButton(U32 number, std::string icon, std::string command,
