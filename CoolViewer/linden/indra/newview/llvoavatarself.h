...
public:
	LLVOAvatarSelf(const LLUUID& id, LLPCode pcode, LLViewerRegion* regionp);
...
public:
	...
	void idleUpdate(const F64& time) override;
...
public:
	...
	LL_INLINE LLGLTexture::EBoostLevel getAvatarBoostLevel() const override
	{
		return LLGLTexture::BOOST_AVATAR_SELF;
	}

	LL_INLINE LLGLTexture::EBoostLevel getAvatarBakedBoostLevel() const override
	{
		return LLGLTexture::BOOST_AVATAR_BAKED_SELF;
	}

	LL_INLINE S32 getTexImageSize() const override
	{
		return 512;
	}

	LL_INLINE S32 getTexImageArea() const override
	{
		return 512 * 512;
	}
 ...
 **/
	...
	bool isLocalTextureDataAvailable(LLViewerTexLayerSet* layerset);
	bool isLocalTextureDataFinal(LLViewerTexLayerSet* layerset);
	bool isBakedTextureFinal(LLAvatarAppearanceDefines::EBakedTextureIndex index);
	...
	//-------------------------------------------------------------------------
#if 0	// Note used
	bool getLocalTextureGL(LLAvatarAppearanceDefines::ETextureIndex type,
						   LLViewerTexture** image_gl_pp, U32 index);
#endif
	...
	void setLocalTexture(LLAvatarAppearanceDefines::ETextureIndex type,
						 LLViewerTexture* tex, bool baked_version_exits,
						 U32 index) override;

protected:
	void setBakedReady(LLAvatarAppearanceDefines::ETextureIndex type,
					   bool baked_version_exists, U32 index) override;
	void localTextureLoaded(bool succcess, LLViewerFetchedTexture* src_vi,
