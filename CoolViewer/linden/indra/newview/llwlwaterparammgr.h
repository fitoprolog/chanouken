...
// WindLight water parameter manager class for the water shaders
...
public:
	...
	void applyToParcel(const LLSD& water_params);

	// Sends the parameters to the shaders
	void propagateParameters();

	// Updates information for the shader
	void update(LLViewerCamera* camera);
