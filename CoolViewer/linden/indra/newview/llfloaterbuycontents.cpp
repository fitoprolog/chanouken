...
void LLFloaterBuyContents::onClickBuy(void* data)
{
	...
	// Make sure this wasn't selected through other mechanisms (i.e. being the
	...
	// *NOTE: doesn't work for multiple object buy, which UI does not currently
	// support sale info is used for verification only, if it does not match
	// region info then the sale is cancelled.
