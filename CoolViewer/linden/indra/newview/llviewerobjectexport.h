...
// callbacks based export worker algorithm as in llviewerobjectbackup.cpp
// should be implemented instead (but it does not make sense implementing it
// either as long as the avatar OBJ export itself is not fixed). HB
