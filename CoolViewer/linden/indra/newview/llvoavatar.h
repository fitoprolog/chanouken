...
public:
	...
	LLVOAvatar(const LLUUID& id, LLPCode pcode, LLViewerRegion* regionp);
...
public:
	...
	// Constants
	//--------------------------------------------------------------------
	LL_INLINE virtual LLGLTexture::EBoostLevel getAvatarBoostLevel() const
	{
		return LLGLTexture::BOOST_AVATAR;
	}

	LL_INLINE virtual LLGLTexture::EBoostLevel getAvatarBakedBoostLevel() const
	{
		return LLGLTexture::BOOST_AVATAR_BAKED;
	}

	LL_INLINE virtual S32 getTexImageSize() const	{ return 128; }

	LL_INLINE virtual S32 getTexImageArea() const	{ return 128 * 128; }
...
protected:
	...
	void addBakedTextureStats(LLViewerFetchedTexture* imagep, F32 pixel_area,
							  F32 texel_area_ratio, S32 boost_level);
...
private:
	...
	class RiggedMatrix final : public LLRefCount
	{
	public:
...
public:
	LLVOAvatarUI(const LLUUID& id, LLPCode pcode, LLViewerRegion* regionp);
