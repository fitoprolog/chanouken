...
public:
	...
	LL_INLINE virtual bool needsRender()					{ return mNeedsUpdate; }
	...
	void genGlodLODs(S32 which_lod = -1, U32 decimation = 3,
...
protected:
	...
	// Minimum amount of allowed triangles in LOD for spinners. Leave at least
	// one triangle per model.
	U32						mMinTriangleLimit;
