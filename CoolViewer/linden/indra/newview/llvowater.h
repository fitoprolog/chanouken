...
public:
	...
	LLVOWater(const LLUUID& id, LLPCode pcode, LLViewerRegion* regionp);

	// Initialize data that's only inited once per class.
	static void initClass()								{}
	static void cleanupClass()							{}

	LL_INLINE void idleUpdate(const F64& time) override	{}
...
{
public:
	LLVOVoidWater(const LLUUID& id, LLPCode pcode, LLViewerRegion* regionp)
	:	LLVOWater(id, pcode, regionp)
	{
