...
public:
	...
	// folder view level.
	static void dragOrDropTip(bool drop, std::string& tooltip_msg);
...
public:
	...
	void doFolder(LLFolderViewFolder* folder) override;
	void doItem(LLFolderViewItem*) override				{}
...
public:
	...
	// Returns true on success, false otherwise
	bool addToFolder(LLFolderViewFolder* folder, LLFolderView* root) override;
...
public:
	...
	typedef void (*SelectCallback)(LLFolderView* folderp, bool user_action,
								   void* userdata);
	...
	LL_INLINE void setSelectCallback(SelectCallback callback, void* userdata)
	{
	...
	LL_INLINE void setNeedsAutoRename(bool val)			{ mNeedsAutoRename = val; }
...
protected:
	...
	// relates to. It's either the task UUID for inworld object (== mSourceID)
...
public:
	...
	LL_INLINE void setSelectCallback(LLFolderView::SelectCallback callback,
									 void* user_data)
	{
		if (mFolders)
		{
