...
LLVOClouds::LLVOClouds(const LLUUID& id, LLPCode pcode,
...
void LLVOClouds::idleUpdate(const F64& time)
{
...
bool LLVOClouds::updateGeometry(LLDrawable* drawable)
{
	...
	{
		cloud_color = LLColor3(gSky.getSunDiffuseColor() +
							   gSky.getSunAmbientColor());
	}
