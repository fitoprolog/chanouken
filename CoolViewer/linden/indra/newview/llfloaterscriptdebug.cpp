...
bool LLFloaterScriptDebug::postBuild()
{
	...
	if (mTabContainer)
	{
#if 0	// *FIX: apparantly fails for tab containers?
										 ...
										 const LLUUID& source_id)
{
	...
	if (objectp)
	{
		...
		tex = LLViewerTextureManager::getFetchedTextureFromFile("script_error.j2c");
	...
	floaterp = LLFloaterScriptDebugOutput::getFloaterByID(LLUUID::null);
...
:	LLFloater(std::string("script instance floater"), LLRect(0, 200, 200, 0),
