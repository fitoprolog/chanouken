...
EOF2
            ...
            echo "Warning: did not register secondlife:// and hop:// handlers with KDE: Directory $LLKDEPROTODIR does not exist."
        fi
    fi
done
...
cat >"$APPSDIR/secondlife-url-handler.desktop" <<EOF3
[Desktop Entry]
Encoding=UTF-8
Version=1.0
