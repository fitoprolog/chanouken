...
const static U32 NUM_VOICE_SYMBOL_WAVES = 7;
...
public:
	...
	static void				lipStringToF32s(std::string& in_string,
											F32*& out_F32s,
											U32& count_F32s);					// convert a string of digits to an array of floats
