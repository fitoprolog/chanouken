...
public:
	...
	LL_INLINE bool isPoolTerrain() override			{ return true; }
...
private:
	// Windlight version
	void renderFullShaderWL(LLViewerTexture* detail_texture0p,
							LLViewerTexture* detail_texture1p,
							LLViewerTexture* detail_texture2p,
							LLViewerTexture* detail_texture3p,
							const LLVector4& tp0, const LLVector4& tp1);
	// Estended environment version
	void renderFullShaderEE(LLViewerTexture* detail_texture0p,
							LLViewerTexture* detail_texture1p,
							LLViewerTexture* detail_texture2p,
							LLViewerTexture* detail_texture3p,
							const LLVector4& tp0, const LLVector4& tp1);
