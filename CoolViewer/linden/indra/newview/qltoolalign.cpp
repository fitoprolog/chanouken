...
bool QLToolAlign::handleDoubleClick(S32 x, S32 y, MASK mask)
{
	return false;
}

LLTool* QLToolAlign::getOverrideTool(MASK mask)
{
	if (!gKeyboardp || !gKeyboardp->getKeyDown('A'))
	{
...
void QLToolAlign::handleDeselect()
{
}
