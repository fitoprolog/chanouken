/**
 * @file llFloaterMyFirstFloater.h
 * @brief LLFloaterMyFirstFloater class definition
 *
...
#ifndef LL_LLFloaterMyFirstFloater_H
#define LL_LLFloaterMyFirstFloater_H
...
class LLFloaterMyFirstFloater final : public LLFloater,
						    public LLUISingleton<LLFloaterMyFirstFloater, LLFloaterMyFirstFloater>
{
protected:
	LOG_CLASS(LLFloaterMyFirstFloater);

public:
	LLFloaterMyFirstFloater(const LLSD& seed);
	~LLFloaterMyFirstFloater() override		{}
	...
	static void chatFromLogFile(LLLogChat::ELogLineType type, std::string line,
								void* userdata);
