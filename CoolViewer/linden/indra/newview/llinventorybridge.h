...
public:
	...
	void previewItem() override								{ openItem(); }
	...
	void move(LLFolderViewEventListener*) override			{}
...
public:
	...
	LL_INLINE virtual bool isUpToDate() const		{ return true; }
	LL_INLINE virtual bool hasChildren() const		{ return false; }

	// Override for LLInvFVBridge
	LL_INLINE virtual void clearDisplayName()		{ mDisplayName.clear(); }
