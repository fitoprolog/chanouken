...
typedef	void (*LLImageCallback)(bool success, LLViewerFetchedTexture* src_vi,
...
public:
	...
	static void processImageNotInDatabase(LLMessageSystem* msg,
										  void** user_data);
...
#if LL_FAST_TEX_CACHE
	typedef std::deque<LLPointer<LLViewerFetchedTexture> > fast_cache_queue_t;
	fast_cache_queue_t	mFastCacheQueue;
#endif
...
public:
	...
	static void onUIImageLoaded(bool success, LLViewerFetchedTexture* src_vi,
								LLImageRaw* src, LLImageRaw* src_aux,
								S32 discard_level, bool is_final,
								void* userdata);
...
extern LLViewerTexture*		gImgBlackSquare;
