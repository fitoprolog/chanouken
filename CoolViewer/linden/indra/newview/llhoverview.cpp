...
void LLHoverView::updateHover(LLTool* current_tool)
{
	...
	if (gViewerWindowp->getMouseVelocityStat()->getPrev(0) < 0.01f &&
		gViewerCamera.getAngularVelocityStat()->getPrev(0) < 0.01f &&
		gViewerCamera.getVelocityStat()->getPrev(0) < 0.01f)
	{
