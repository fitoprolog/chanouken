...
%{?_with_gcc102:	%{expand: %%global opt_compiler -v10.2}}
%{?_with_gcc101:	%{expand: %%global opt_compiler -v10.1}}
%{?_with_gcc100:	%{expand: %%global opt_compiler -v10.0}}
%{?_with_gcc93:		%{expand: %%global opt_compiler -v9.3}}
%{?_with_gcc83:		%{expand: %%global opt_compiler -v8.3}}
%{?_with_gcc74:		%{expand: %%global opt_compiler -v7.4}}
%{?_with_gcc65:		%{expand: %%global opt_compiler -v6.5}}
%{?_with_gcc55:		%{expand: %%global opt_compiler -v5.5}}
...
Requires:		glibc >= 2.8
Requires:		libstdc++6
Requires:		glib2 >= 2.32.2
Requires:		libfontconfig
# CEF3 plugin dependencies:
Requires:		libx11 >= 1.5.0
Requires:		libxi >= 1.6.1
Requires:		nspr >= 4.9.0
Requires:		nss >= 3.14.0

BuildRoot:		%{_tmppath}/%{name}-%{version}-buildroot
BuildRequires:	python >= 2.4.3
